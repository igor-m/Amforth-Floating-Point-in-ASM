...
;  of the License.
;
;     16-9-2010 v.1.0 IgorM 
;     22-9-2010 v.1.1 IgorM 
;     22-9-2010 BUG FIXED: FDIV shall use R0, R1 instead R8, R9
;     27-5-2011 v.2.0 IgorM 
;     27-5-2011 BUG FIXED: T-flag dependency fully removed 
;               Added: fsqrt
;     15-5-2015 v.2.1 IgorM, github
;
; Note:
...
;
; How to install the 5primitives words:
...
;			!! DO NOT forget to remove or comment-out 
